...
public class LookupTableTest
{
    ...
    public void testLoadingCorrect(){
        LookupTableSharding lts = new LookupTableSharding("/home/orm/thesis/shardlib/test/com/twitter/dataservice/sharding/testpartition.part", 1, "\t");
    ...
    public void testArrayConstructor(){
        ...
        LookupTableSharding control = new LookupTableSharding("test/com/twitter/dataservice/sharding/testpartition.part", 1, "\t");
