...
%note: \begin{landscape} \end{landscape} and \subfloat[]{} for horizontal
%subplots in horizontal page.
...
\begin{figure}
\mbox{
  \subfigure{\includegraphics[width=\gridscale]{figures/LOG-LOG-plot-of-indeg-vs-edgeq-log-correl002.png}}
  \subfigure{\includegraphics[width=\gridscale]{figures/LOG-LOG-plot-of-indeg-vs-intersectionq-log-correl020.png}}
  \subfigure{\includegraphics[width=\gridscale]{figures/LOG-LOG-plot-of-indeg-vs-fanoutq-log-correl001.png}}
  \subfigure{\includegraphics[width=\gridscale]{figures/LOG-LOG-plot-of-indeg-vs-outdeg-log-correl076.png}}
}

\mbox{
  \subfigure{\includegraphics[width=\gridscale]{figures/LOG-LOG-plot-of-outdeg-vs-edgeq-log-correl004.png}}
  \subfigure{\includegraphics[width=\gridscale]{figures/LOG-LOG-plot-of-outdeg-vs-intersectionq-log-correl009.png}}
  \subfigure{\includegraphics[width=\gridscale]{figures/LOG-LOG-plot-of-outdeg-vs-fanoutq-log-correl006.png}}
}
...
\begin{figure}
  \begin{center}
      \scalebox{0.25}{\includegraphics{vertex-fanout.png}}
      \scalebox{0.25}{\includegraphics{two-tier2m-fanouts.png}}
      \scalebox{0.25}{\includegraphics{all-shards-fanout.png}}
  \end{center}
  \label{fig:fanout}
...
\begin{figure}
  \begin{center}
      \scalebox{0.25}{\includegraphics{vertex-intersection.png}}
      \scalebox{0.25}{\includegraphics{two-tier2m-intersection.png}}
      \scalebox{0.25}{\includegraphics{workload-intersection.png}}
  \end{center}
