...
exceptions = load '$EXCEPTIONS' as (vertexid:int);
...
mapped_special = foreach edge_cases generate com.twitter.dataservice.sharding.VERTEXHASHSHARD(leftid, rightid, $NUMNODES, $NUMSHARDS) as node, leftid, rightid;
